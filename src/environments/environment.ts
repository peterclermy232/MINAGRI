...
export const environment: ENV = {
  ...
  authUrl: 'http://127.0.0.1:8000/api/v1/auth',
// 8000
  ...
  crop_baseurl: 'http://127.0.0.1:8001/api/v1',
  auth_baseurl: 'http://127.0.0.1:8001/api/v1',
  oauth_baseurl: 'http://127.0.0.1:8001/api/v1',
};
